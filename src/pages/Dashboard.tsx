...
import { FileText, Clock, CheckCircle, Users, Newspaper, AlertCircle, XCircle, ExternalLink, Sparkles, Loader2, Save, FileSignature, Trash2, Share2, Calendar as CalendarIcon, Plus, Copy, UserPlus, ChevronsUpDown, CheckCheck, Download, Mail, Edit } from 'lucide-react';
                ...
                <div className="grid gap-4 py-4">
                    ...
                    <div>
                        ...
                        <Select value={templateId} onValueChange={setTemplateId}>
                            ...
                            <SelectContent>
                                <SelectItem value="template1">Professional Blue</SelectItem>
                                <SelectItem value="template2">Futuristic Dark</SelectItem>
                                <SelectItem value="template3">Minimalist Blue</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </div>
